package com.dot.ai.commonservice.util;
...
public class AESUtil {
    ...
    public static String encrypt(String requestBodyToEncrypt, String channelKey) {
        if(requestBodyToEncrypt == null || StringUtils.isBlank(channelKey)){
            log.error("invalid request body or channelKey{}", requestBodyToEncrypt, channelKey);
            return null;
        }
    ...
    public static synchronized String decrypt(String encryptedResponse, String channelKey) {
        if(StringUtils.isBlank(encryptedResponse) || StringUtils.isBlank(channelKey)){
            return null;
        }
        SecretKeySpec channelKeySpec;
        Cipher cipher;
